...
var app = new Vue({
    ...
    data: {
        ...
        supports: [
            { text: 'Pampi', value: 'Pampi' },
            { text: 'Ramagia', value: 'Ramagia' },
            { text: 'Juan Surf', value: 'Juancho Surf' },
            { text: 'Gachóforo', value: 'Gachóforo' },
            { text: 'Juampirulo', value: 'Juampirulo' },
            { text: 'Ruichensen', value: 'Ruichensen' },
            { text: 'Rochu', value: 'Rochu' },
            { text: 'Crischo', value: 'Crischo' },
            { text: 'Franquini', value: 'Franquini' },
            { text: 'Joaquito', value: 'Joaquito' },
        ],
        cartHas: {
            verdura: false,
            fruta: false,
    ...
    methods: {
        ...
        formValidate() {
            // form validation
            if ( this.userData.support == '' || this.userData.pago == '') {
        ...
        setSupport(event) {
            this.userData.support = event.target.value;
        ...
        saveSale(cart) {
            ...
            var self = this;
            database.ref('sales/local/').push(sale, function (error) {
                if (error) {
                    console.log(error)
                } else {
            ...
            database.ref('salesArchive/local/').push(sale, function (error) {
                if (error) {
                    console.log(error)
                } else {
                    self.saleComplete = true;
